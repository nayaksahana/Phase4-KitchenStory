	...
	<nav class="navbar navbar-expand-lg navbar-light">
		<div class="collapse navbar-collapse" style="display:inline!important;" id="navbarCollapse">
        	<ul class="navbar-nav mr-auto nav nav-justified">
            	<li class="nav-item">
            		<a class="nav-link" href="index.jsp" style="color: #ff0000; font-size: large;">Customer Login</a>
          		</li>
          		<li class="nav-item">
            		<a class="nav-link" href="admin-login.jsp" style="color: #ff0000; font-size: large;">Admin Login</a>
          		</li>
			</ul>
		</div>
   </nav>
